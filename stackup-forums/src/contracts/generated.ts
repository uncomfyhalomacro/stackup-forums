...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link forumAbi}__ and `functionName` set to `"userPolls"`
 */
export const useReadForumUserPolls = /*#__PURE__*/ createUseReadContract({
  abi: forumAbi,
  functionName: 'userPolls',
})

/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link forumAbi}__ and `functionName` set to `"userVotedComments"`
 */
export const useReadForumUserVotedComments =
  /*#__PURE__*/ createUseReadContract({
    abi: forumAbi,
    functionName: 'userVotedComments',
  })

/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link forumAbi}__ and `functionName` set to `"userVotedPosts"`
 */
export const useReadForumUserVotedPosts = /*#__PURE__*/ createUseReadContract({
  abi: forumAbi,
  functionName: 'userVotedPosts',
})
